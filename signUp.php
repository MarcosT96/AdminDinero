...
//incluir pagina de notificaciones
...
if(isset($_POST['signup'])){
	if($_POST['email'] == '' || $_POST['firstname'] == '' || $_POST['lastname'] == '' || $_POST['password'] == '' || $_POST['rpassword'] == '') {
				...
				if($statement = $mysqli->prepare($sql)){
					//Parametros de enlace para marcadores, donde (s = string, i = integer, d = double,  b = blob)
...
<head>
    ...
    <title>Registro de administrador de dinero</title>
...
<body>
    ...
    <div class="container">
        ...
        <div class="row text-center">
            <small >copyright © <?php echo Date('Y');?> Administrador de Dinero | Todos los derechos reservados</small><br>
            <small >Desarollado por Marcos</small>
        </div>
    </div>
