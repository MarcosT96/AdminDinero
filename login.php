...
//incluir pagina de notificacion
        ...
        if ($_POST['password'] == '') {
            ...
            if ($stmt = $mysqli->prepare("SELECT UserId, FirstName, LastName, Email, Password, Currency from user WHERE Email = ? AND Password = ? ")) {
                ...
                if ($num_of_rows = $stmt->num_rows >= 1) {
                    ...
                    // Generar categoría predeterminada para el nuevo usuario
...
<head>
    ...
    <title>Administrador de Dinero</title>
...
$RegisterAnAccount; ?></a>
        ...
        <div class="row text-center">
            ...
            <small >Powered By Marcos Tomassi</small>
        </div>
    </div>
